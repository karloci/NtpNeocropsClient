...
{
    partial class ConsumptionsForm
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ConsumptionsForm));
            buttonAddConsumption = new Button();
            ...
            SuspendLayout();
            // 
            // buttonAddConsumption
            // 
            resources.ApplyResources(buttonAddConsumption, "buttonAddConsumption");
            buttonAddConsumption.Name = "buttonAddConsumption";
            buttonAddConsumption.UseVisualStyleBackColor = true;
            buttonAddConsumption.Click += buttonAddPurchase_Click;
            // 
            ...
            Controls.Add(buttonAddConsumption);
            Name = "ConsumptionsForm";
            Load += PurchasesForm_Load;
            Controls.SetChildIndex(buttonAddConsumption, 0);
        ...
        private Button buttonAddConsumption;
